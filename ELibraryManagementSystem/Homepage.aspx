...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <section>
      <div class="container">
         <div class="row">
            <div class="col-12"><%--any row contains 12 coloumn in it --%>
               <center>
                  <h2>What we Offer ?</h2>
         ...
         <div class="row">
            <div class="col-md-4"><%--we can divide the 12 coloumns in 3 parts so that when we minimise the screen the content will adjust automatically--%>
               <center>           <%--we have three coloumns in our project those three will get vertically inline in mobile or small screen  --%>
